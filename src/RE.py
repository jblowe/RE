...
class Quirk:
    def __init__(self, id, source_id, language, form, gloss, slot, value, notes):
        self.id = id
    ...
    def __repr__(self):
        return f'<Quirk({self.id}, {self.source_id}, {self.language}, {self.form}, {self.gloss}, {self.slot}, {self.value}, {" ".join(self.notes)})>'
