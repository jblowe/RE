...
[ $? -ne 0 ] && exit 1;
python3 $1/csv_to_re.py C20230809v1.csv TGTM.C20230809v1.correspondences.xml TGTM.classes.xml
[ $? -ne 0 ] && exit 1;
...
perl Lex2XML.pl MONTANG_2023.DAT TEMP.tang.data.xml tang.xml.log tang
...
perl -i -p addngl.pl TGTM.tang.data.xml
