...
[ $? -ne 0 ] && exit 1;
python3 $1/csv_to_re.py TGTM.20230508.csv TGTM.20230508.correspondences.xml TGTM.classes.xml
[ $? -ne 0 ] && exit 1;
...
perl Lex2XML.pl MONTANG_1978.DAT TEMP.tang.data.xml tang.xml.log tang
