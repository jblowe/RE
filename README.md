...
* The 'web interface', a bottle+bootstrap interfact to allow users to browse the projects and results, either locally or on the web.
...
#### past code and other goodies for posterity
