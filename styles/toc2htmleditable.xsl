  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <title>tableOfCorr — Editable</title>
      ...
      <body>
        <div class="container my-4">
          <h1 class="h5 mb-3">Editable tableOfCorr</h1>
            ...
            <thead class="table-light">
              <tr>
                <th class="actions-col">
                  <button type="button" id="addRowBtn" class="btn btn-outline-primary btn-sm btn-icon" title="Add row">+</button>
                </th>
                <th>num</th>
                <th>*</th>
                <th>syll</th>
              ...
              <xsl:for-each select="corr">
                ...
                <tr id="row-{$rpos}">
                  ...
                  <td class="actions-col">
                    <button type="button" class="btn btn-outline-danger btn-sm btn-icon btn-del-row" title="Delete row">-</button>
                  </td>
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm cell-input"
                      ...
                      <xsl:attribute name="value"><xsl:value-of select="normalize-space(proto)"/></xsl:attribute>
                    </input>
                  </td>
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm cell-input"
                      ...
                      <xsl:attribute name="value"><xsl:value-of select="proto/@syll"/></xsl:attribute>
                    </input>
                  </td>
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm cell-input"
                      ...
                      <xsl:attribute name="value"><xsl:value-of select="proto/@contextL"/></xsl:attribute>
                    </input>
                  </td>
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm cell-input"
                      ...
                      <xsl:attribute name="value"><xsl:value-of select="proto/@contextR"/></xsl:attribute>
                    </input>
                  </td>
                  ...
                  <tr id="rule-row-{$r}">
                    ...
                    <td>
                      <input type="text" class="form-control form-control-sm"
                        ...
                        <xsl:attribute name="value"><xsl:value-of select="normalize-space(input)"/></xsl:attribute>
                      </input>
                    </td>
                    <td>
                      <input type="text" class="form-control form-control-sm"
                             name="rule-{$r}-output" id="rule-{$r}-output">
                        <xsl:attribute name="value"><xsl:value-of select="normalize-space(outcome)"/></xsl:attribute>
                      </input>
                    </td>
                    <td>
                      <input type="text" class="form-control form-control-sm"
                             name="rule-{$r}-contextL" id="rule-{$r}-contextL">
                        <xsl:attribute name="value"><xsl:value-of select="input/@contextL"/></xsl:attribute>
                      </input>
                    </td>
                    <td>
                      <input type="text" class="form-control form-control-sm"
                             name="rule-{$r}-contextR" id="rule-{$r}-contextR">
                        <xsl:attribute name="value"><xsl:value-of select="input/@contextR"/></xsl:attribute>
                      </input>
                    </td>
                    <td>
                      <input type="text" class="form-control form-control-sm"
                             name="rule-{$r}-stage" id="rule-{$r}-stage">
                        <xsl:attribute name="value"><xsl:value-of select="@stage"/></xsl:attribute>
                      </input>
                    </td>
                    <td>
                      <input type="text" class="form-control form-control-sm"
                             name="rule-{$r}-languages" id="rule-{$r}-languages">
                        <xsl:attribute name="value"><xsl:value-of select="outcome/@languages"/></xsl:attribute>
                      </input>
                    </td>
                  </tr>
                </xsl:for-each>
